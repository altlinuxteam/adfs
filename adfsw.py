...
#            _dn = v.get_dn(dn, '%s,%s' % (objCat, self.schemaDN))
#            raw_data = self.ad.get_attrs(_dn, v.attrs)
#            self.set_inode_data(sn_inode, v.data_from_raw(dn, raw_data))
